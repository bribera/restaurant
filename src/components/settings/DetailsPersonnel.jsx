...
const DetailsPersonnel = ({onClose}) => {
  ...
  return (
    ...
    <div className=" basis-2/5 ">
      <div className="min-h-screen gap-5 flex-col p-[20px] bg-white">
          ...
          {/* information du nouveau personnel */}
          <div className="flex flex-col gap-[40px]">
              {/* title */}
              <div className="flex flex-col gap-2 ">
                  <p className="text-[#0fa921] text-[22px] lg:text-[32px] leading-[52.71px] tracking-[2%] font-bold">Ajoutez un nouveau personnel</p>
                    ...
                    <div className="flex flex-col gap-[19px] justify-between">
                        ...
                        <div className="flex flex-col justify-start gap-[9px] lg:gap-[19px]">
                            ...
                            <select  onChange={handleMenuFilterChange} value={filterMenu} className='w-full bg-[#F1F1F1] p-2 placeholder:px-4'>
                                <option value="drink">En ligne</option>
                                <option value="food">Sur place</option>
                                <option value="cake">Emporté</option>
                            </select>
                        </div>  
