      ...
      <div className="min-h-screen gap-5 flex-col p-[20px] bg-white">
          ...
          <div className="flex flex-col gap-[40px]">
              ...
              <div className="flex flex-col gap-2 ">
                  <p className="text-[#0fa921] text-[22px] lg:text-[32px] leading-[52.71px] tracking-[2%] font-bold">Ajoutez un nouveau menu</p>
                ...
                <div className="">
                    <div className="flex flex-col gap-[19px] justify-between">
                        ...
                        <div className="flex flex-col justify-start gap-[9px] lg:gap-[19px]">
                            <div className="">
                                <p className="lg:text-[20px] text-[16px] leading-[25.1px] font-bold">Informations sur le nouveau menu</p>
                            </div>

                            {/* Type de menu */}
                            <div className="border text-[10px] lg:text-[18px]">
                            <select  onChange={handleMenuFilterChange} value={filterMenu} className='w-full bg-[#F1F1F1] p-2 placeholder:px-4'>
                                <option value="drink">Boissons</option>
                                <option value="food">Nourritures</option>
                                <option value="cake">Gateaux</option>
                            ...
                            <div className="flex flex-col gap-[16px]">
                              <div className="flex gap-2">
                                  <label htmlFor="photo" className='text-[#646464] lg:text-[20px] text-[16px] leading-[25.1px] font-semibold'>Photo du menu</label>
                              </div>
                            ...
                            <div className="flex flex-col gap-[16px]">
                                <div className="flex gap-2">
                                    <label htmlFor="surname" className='text-[#646464] lg:text-[20px] text-[16px] leading-[25.1px] font-semibold'>Caractéristique</label>
                                </div>
                                <div className="">
                                    <textarea type="text" name="" id="surname" className='w-full bg-[#F1F1F1] p-2 placeholder:px-4'/>
                                </div>
                            </div>
                        </div>
                    </div>
